...
function Paso2() {
    return (<div className="paso">
        <h2>Paso 2. ¿Se puede patentar?</h2>
        <br />
            ...
            <div className="row">
                <div className="col-6 text-left">
                    ...
                    <div className="text-justify">
                        <ul>
                            ...
                            <li>El todo o parte de seres vivos tal como se encuentran en la naturaleza</li>
                            <li>Los procesos biológicos naturales</li>
                            <li>Las obras literarias, artísticas, científicas o cualquier otra protegida por el derecho de autora</li>
                            <li>Material biológico existente en la naturaleza o aquel que pueda ser aislado</li>
                            <li>El genoma de cualquier ser vivo natural</li>
                            <li>Planes, reglas y métodos para el ejercicio de actividades intelectuales, juegos o actividades económico-comerciales</li>
                        </ul>
                    </div>
                </div>
                <div className="col-6 text-right">
                    ...
                    <div className="text-justify">
                        ...
                        <ol>
                       <li>Debe ser novedoso, es decir, que no exista a nivel mundial. En esto le ayudamos en el Paso 3.</li>
                       <li>Debe poseer un nivel inventivo, lo que equivale a decir, que no sea un desarrollo obvio para alguien experto en la materia que trata el invento.</li>
                       <li>Que lo inventado pueda ser utilizado o fabricado en cualquier industria, es decir, que debe tener una aplicación industrial.</li>     
                        </ol>
                    </div>
                </div>
            </div>
